...
layout = dbc.Container(
    dbc.Col([
        ...
        # y Slider
        dcc.Slider(id="joint-y", min=smin, max=smax, value=randint(smin*10, smax*10)/10, updatemode='drag', marks=None,
                   tooltip={"template": "ŷ={value}", "placement": "bottom", "always_visible": True}),

        # ρ Slider
        dcc.Slider(id="joint-ρ", min=-1, max=1, value=randint(-9, 9)/10, updatemode='mouseup', marks=None,
