...
layout = dbc.Container([
    dcc.Markdown(
        ...
        - Distributed Sampling: Fusion of two 2D Gaussians; show naive, CI, ICI; sliders for w parameter and 4 variances, 2 visible and 4 hidden correlations
        - try: Dash Draggable
        ...
        - Optimization: Steepest Descent, Gauß-Newton, Levenberg-Marquardt, Newton, SDP
        '''
        )
